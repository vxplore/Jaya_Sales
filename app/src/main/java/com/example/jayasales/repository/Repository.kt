...
interface Repository {
    ...
    suspend fun checkInOut(userId: String, lat: String, lng: String, comment: String, status: String) : CheckInOutDataResponse?
    ...
    suspend fun receivePayment(
        userId: String,
        orderId: String,
        storeId: String, price: String,
        paymentType: PaymentModeTab, instruction: String): ReceivePaymentInList?
